...
def run_distance(first_frame):
    ...
    for p in photons:
        ...
        ph_df.to_hdf('/ceph/ihaide/distances/3D/3dKS_singletoall_70ns_{}_{}_photons{}.h5'.format(first_frame, last_frame, p), key = 'ph_df', mode = 'w', complevel=9, complib='blosc:lz4')
...
if __name__ == '__main__':
    ...
    processes = []
    for first in np.arange(0, 700, 100):
